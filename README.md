...
---
## 更新
1. 下载画布：以图片形式将当前画布内容导出为可保存的图片文件。
2. 删除对象与注解：支持选中并删除画布中的对象或注解。
3. 缩放对象：支持对画布中的对象进行放大和缩小。
4. 关系图画面调整：优化表示人物的圆圈，使其尺寸不要过大，并适当增大两个圆圈之间的间距，让整体布局更协调。
5. 时间线优化：让时间线上表示时间段的涂画效果更简洁、美观。
---
## 预览
